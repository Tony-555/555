...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\aarri\\555\\FER-T 1.0\\FER-T.py',
...
image = visual.ImageStim(
    ...
    ori=0, pos=[-0.5, 0], size=[0.35, 0.35],
...
text = visual.TextStim(win=win, name='text',
    text='1: Enojo\n2: Asco\n3: Miedo\n4: Felicidad\n5: Trsteza\n6: Sorpresa',
    font='Arial',
    pos=[0, -0.5], height=0.03, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-4.0);
text_3 = visual.TextStim(win=win, name='text_3',
    text='Neutral',
    font='Arial',
    pos=[-0.5, -0.5], height=0.03, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-5.0);
...
for thisTrial in trials:
    ...
    _key_resp_2_allKeys = []
    # keep track of which components have finished
    trialComponents = [ISI, image, image_2, key_resp_2, text, text_3]
